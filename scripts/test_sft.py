...
用法：
    ...
    # 手动对话模式
    python scripts/test_sft.py --mode chat
...
def main():
    parser = argparse.ArgumentParser(description="测试 SFT 模型的对话能力")
    parser.add_argument('--weight_dir', default='out', type=str, help="权重目录")
    parser.add_argument('--weight_name', default='full_sft', type=str, help="权重名称前缀")
