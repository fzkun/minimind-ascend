#!/bin/bash
# 训练烟雾测试：验证所有 4 种训练任务都能正常跑通
# 用法: bash scripts/test_train.sh
#
...
# ---------- 1. 预训练 ----------
echo ""
echo "[1/4] 测试预训练 (train.py --task pretrain) ..."
...
# ---------- 2. SFT ----------
echo ""
echo "[2/4] 测试 SFT (train.py --task sft) ..."
...
# ---------- 3. LoRA ----------
echo ""
echo "[3/4] 测试 LoRA (train.py --task lora) ..."
...
# ---------- 4. 推理蒸馏 ----------
echo ""
echo "[4/4] 测试推理蒸馏 (train.py --task reason) ..."
